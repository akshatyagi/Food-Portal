...
?>
        <section>
            <h1 style='color:red'>DELETING A USER ENTRY</h1>
            <h3 style='color:yellow'>USER RECORDS:</h3>
            <?php
          if(isset($_POST['submit'])){
           ...
           <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
                            ...
                            <label style="color:#0017C4" for="usr" id="HOME_ADDRESS_LOCALITY">Enter the Username of the entry to be deleted:</label>
                            <input style="width:400px" type="text" class="form-control" name="uname">   

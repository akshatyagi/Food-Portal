...
<div class="container-fluid">
  ...
  <div>
    ...
    <section id="loginsection">
        <div id="logindiv">
        <h3 style="color:yellow">Kindly Enter your Username and Password to Login to Admin Page:</h3>
           <br> <br>
            <div id="ldiv">
            <form method="post" action="login.php">
                
            <label style="color:#0017C4" for="usr" id="USERNAME">Username:</label><br>
            <input style="width:600px" type="text" name="username" id="logu" class="form-control" placeholder='Registered Username'>
                 
            <br><br>
       
            <label style="color:#0017C4" for="usr" id="LASTNAME">Password:</label><br>
            <input style="width:600px" type="password" id="logpass" class="form-control" name="password" placeholder='Registered Password'>
